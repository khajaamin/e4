...
<div class="blog-form">
   ...
   <!--  <?= $form->field($model, 'bsc_id')->dropDownList(
    ...
    <?= $form->field($model, 'blog_verified')->dropDownList([ 'Y' => 'Yes', 'N' => 'No', ], ['prompt' => '']) ?>

    <?= $form->field($model, 'blog_featured')->dropDownList([ 'Y' => 'Yes', 'N' => 'No', ], ['prompt' => '']) ?>
